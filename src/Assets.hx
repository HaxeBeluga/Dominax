...
class Assets
{
    ...
    macro public static function build() : Expr
    {
        ...
        Context.addResource("page_accueil", File.getBytes("src/modules/account_service/tpl/accueil.mtt"));
        Context.addResource("page_subscribe", File.getBytes("src/modules/account_service/tpl/subscribe.mtt"));
        Context.addResource("page_login", File.getBytes("src/modules/account_service/tpl/login.mtt"));
        //#----TicketService Pages----#
        Context.addResource("page_ticket_widget", File.getBytes("src/modules/ticket_service/tpl/ticket_widget.mtt"));
        //#----SurveyService Pages----#
        Context.addResource("page_survey", File.getBytes("src/modules/survey_service/tpl/survey_page.mtt"));
        //#----NotificationService Pages----#
        Context.addResource("page_notification", File.getBytes("src/modules/notification_service/tpl/notification_page.mtt"));
        //#----WalletDemo Pages----#
